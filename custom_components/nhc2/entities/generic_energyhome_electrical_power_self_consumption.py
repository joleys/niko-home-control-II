...
class Nhc2GenericEnergyhomeElectricalPowerSelfConsumptionEntity(NHCBaseEntity, SensorEntity):
    ...
    def __init__(self, device_instance: CocoGenericEnergyhome, hub, gateway):
        ...
        self._attr_unique_id = device_instance.uuid + '_electrical_power_self_consumption'
