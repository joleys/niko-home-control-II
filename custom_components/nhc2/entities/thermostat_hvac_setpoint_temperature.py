...
class Nhc2ThermostatHvacSetpointTemperatureEntity(SensorEntity):
    ...
    def __init__(self, device_instance: CocoThermostatHvac, hub, gateway):
        ...
        self._attr_native_value = self._device.status_setpoint_temperature
        self._attr_native_unit_of_measurement = UnitOfTemperature.CELSIUS
        self._attr_state_class = None

    @property
    def name(self) -> str:
        return 'Thermostat Setpoint Temperature'
